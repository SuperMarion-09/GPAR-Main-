												...
												<tr>
													...
													<tr>
														...
														<tr>
															...
															<tr>
																<td><b>Check-out date:</b>&nbsp;<span>{{\Carbon\carbon::parse($date_in)->format('F j, Y')}} </span></td>
														...
														<tr>
															<td colspan="2">
																<a class="btn btn-success btn-lg pull-right" data-toggle="modal" data-target="#submit" data-id="" href="paymet.html">Cash</a>
																	<a class="btn btn-info btn-lg pull-right paypal" data-toggle="modal" data-target="#paypal" data-id="{{$totalr}}" href="paymet.html">Paypal</a>
